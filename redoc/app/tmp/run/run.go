...
import (
	...
	_ "goblog/app"
	controllers1 "goblog/app/controllers"
...
func Register() {
	...
	revel.RegisterController((*controllers1.Comment)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "CheckUser",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.GormController)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Begin",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.Post)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "CheckUser",
				Args: []*revel.MethodArg{ 
		...
		[]*revel.MethodType{
			...
			&revel.MethodType{
				...
				Args: []*revel.MethodArg{ 
					...
					&revel.MethodArg{Name: "oldPassword", Type: reflect.TypeOf((*string)(nil)) },
					&revel.MethodArg{Name: "newPassword", Type: reflect.TypeOf((*string)(nil)) },
					&revel.MethodArg{Name: "newPasswordConfirm", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
